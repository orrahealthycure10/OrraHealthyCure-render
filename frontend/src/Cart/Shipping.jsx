...
function Shipping() {
  ...
  const shippingInfoSubmit = (e) => {
    ...
    if (!address.trim()) {
      toast.error('Please enter your address', { position: 'top-center', autoClose: 3000 });
      return;
    }
    
    if (!pinCode.trim()) {
      toast.error('Please enter your pin code', { position: 'top-center', autoClose: 3000 });
      return;
    }
    ...
    if (!country) {
      toast.error('Please select a country', { position: 'top-center', autoClose: 3000 });
      return;
    }
    
    if (!state) {
      toast.error('Please select a state', { position: 'top-center', autoClose: 3000 });
      return;
    }
    
    if (!city) {
      toast.error('Please select a city', { position: 'top-center', autoClose: 3000 });
      return;
    }
