...
import "../componentStyles/Footer.css"; // Assuming you have a CSS file for styling
...
import UPI from '../assets/bhmi.png';
    ...
    <footer className="footer">
      <div className="footer-top">
        ...
        <div className="footer-left">
          ...
          <address>
            Plot-68,<br />
            Ugyog Vihar, Sector 18<br />
            Gurugram, Haryana 122001
          </address>
          {/* <div className="contact-info">
            <p>📞 1800-274-2575</p>
            <p>✉️ info@orrahealthycure.in</p>
          </div> */}
        </div>
        ...
        <div className="footer-right">
          ...
          <div className="social-icons">
           ...
           {/* <!-- From Uiverse.io by  -->  */}
<div class="container">
<a href="https://www.instagram.com/orrahealthycure?igsh=MXUxdG5ndG5mbjh2dA==">
  ...
  <button class="Btn instagram">
    ...
    {/* //facebook */}
    <a href="https://www.facebook.com/share/19ajm7S4K5/">
<button class="Btnface">
  ...
  <div class="textf">Facebook</div>
</button>
</a>



<a href="https://youtube.com/@orrahealthycure?si=qqLdAmSSeLqk8DjM">
  ...
  <button class="Btn twitter">
    ...
    <span class="text">Twitter</span>
      ...
      <div className="footer-legal">
        ...
        <p>
          OrraHealthyCure is a company of Adret Retail Private Limited © Copyright
          2025 Orra
        </p>
      </div>
    </footer>
